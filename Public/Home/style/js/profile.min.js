...
!function (a, b) {
    ...
    window.onbeforeunload = function () {
        ...
        submitHandler: function (a) {
            var b = $('input[name="name"]', a).val(), c = $('input[name="gender"]:checked', a).val(), d = $('input[name="topDegree"]', a).val(), e = $('input[name="workyear"]', a).val(), f = $('input[name="currentState"]', a).val(), g = $('input[name="email"]', a).val(), h = $('input[name="tel"]', a).val(), i = $("#pageType").val(), j = $("#resumeId").val(), l = $("#resubmitToken").val();
            $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
        ...
        $(this).validate({
            ...
            submitHandler: function (a) {
                var b = $('input[name="schoolName"]', a).val(), c = $('input[name="degree"]', a).val(), d = $('input[name="professionalName"]', a).val(), e = $('input[name="schoolYearStart"]', a).val(), g = $('input[name="schoolYearEnd"]', a).val(), h = $(".eduId", a).val(), i = $("#resumeId").val(), j = $("#resubmitToken").val();
                $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
...
!function (a, b) {
    ...
    window.onbeforeunload = function () {
        ...
        submitHandler: function (a) {
            var b = $('input[name="name"]', a).val(), c = $('input[name="gender"]:checked', a).val(), d = $('input[name="topDegree"]', a).val(), e = $('input[name="workyear"]', a).val(), f = $('input[name="currentState"]', a).val(), g = $('input[name="email"]', a).val(), h = $('input[name="tel"]', a).val(), i = $("#pageType").val(), j = $("#resumeId").val(), l = $("#resubmitToken").val();
            /*表单上传*/
            ctx = ctx.substring(0, ctx.length - 2);
            $.ajax({
                type: "POST",
                data: {
                    name: b,
                ...
                $("#resubmitToken").val(b.resubmitToken),
                    b.success ? "/resume/userinfo.html" == b.content.url ? window.location.href = ctx + b.content.url : (c = b.content.resume, d = c.workYear, "应届毕业生" != d ? (d += "工作经验", $("#workExperience h2 span").text("（投递简历时必填）")) : $("#workExperience h2 span").text(""), e = c.name, "" != c.sex && (e += " | " + c.sex), "" != c.highestEducation && (e += " | " + c.highestEducation), e += " | " + d + "<br />" + c.phone + " | " + c.email + "<br />" + c.status, $(".collapsible_menu dt").html(c.name + "<i></i>"), $("#basicInfo .basicShow span").html(e).parent().removeClass("dn"), $("#basicInfo .basicEdit").addClass("dn"), $("#basicInfo .c_edit").removeClass("dn"), $("#nameVal").val(c.name), $("#genderVal").val(c.sex), $("#topDegreeVal").val(c.highestEducation), $("#workyearVal").val(c.workYear), $("#currentStateVal").val(c.status), $("#emailVal").val(c.email), $("#telVal").val(c.phone), $("#lastChangedTime span").text(b.content.refreshTime), b.content.isNew && changeAllIds(b.content.jsonIds), scoreChange(b.content.infoCompleteStatus.score), k($("#basicInfo"))) : alert(b.msg)
            })
        }
    }), $("#profileForm .btn_profile_cancel").bind("click", function () {
        $(this).parents(".basicEdit").addClass("dn").siblings(".basicShow").removeClass("dn"), $("#basicInfo .c_edit").removeClass("dn"), k($("#basicInfo"))

...
$(function () {
    ...
    $(".tipExpire .expire_close").bind("click", function () {
        ...
        submitHandler: function (a) {
            var b = $("#companyId").val(), c = $("#companyFeatures").val() != $("#companyFeatures").attr("placeholder") ? $("#companyFeatures").val() : "", d = $("#companyShortName").val() != $("#companyShortName").attr("placeholder") ? $("#companyShortName").val() : "";
        ...
        submitHandler: function (a) {
            var b = $("#companyId").val(), c = $.trim($("#companyProfile").val()) != $("#companyProfile").attr("placeholder") ? $.trim($("#companyProfile").val()) : "", d = $(a).parents(".profile_wrap");
            $(a).find(":submit").attr("disabled", !0), $.ajax({
                type: "POST",
        ...
        submitHandler: function (a) {
            var b = $("#companyId").val(), c = $("#city", a).val(), d = $("#industryField", a).val(), e = $("#companySize", a).val(), f = $("#companyUrl", a).val();
            $(a).find(":submit").attr("disabled", !0), $.ajax({
                type: "POST",
        ...
        obj: $("#Reported"), addReport: function () {
            ...
            this.obj.find("ul.reset").append(a).removeClass("dn"), $(".reportForm", a).validate({
                ...
                submitHandler: function (a) {
                    var b = $('input[name="articleTitle"]', a).val() != $('input[name="articleTitle"]', a).attr("placeholder") ? $('input[name="articleTitle"]', a).val() : "", c = $('input[name="articleUrl"]', a).val() != $('input[name="articleUrl"]', a).attr("placeholder") ? $('input[name="articleUrl"]', a).val() : "", d = $(".article_id", a).val(), e = $("#companyId").val(), f = $("#resubmitToken").val();
                    $(a).find(":submit").attr("disabled", !0), $.ajax({

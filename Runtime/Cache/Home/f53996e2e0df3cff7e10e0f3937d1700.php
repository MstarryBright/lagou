...
<div id="body">
    <div id="header">
        <div class="wrapper">
            ...
            <ul class="reset" id="navheader">
                <li><a href="<?php echo U('Pros/index');?>">首页</a></li>
    ...
    <div id="container">
        ...
        <div class="clearfix">
                    ...
                    <?php foreach($res as $v){?>    
                        <li>
                            <a href="h/c/25842.html" target="_blank">
                                <h3 title="博雅"><?php echo $v['cname']?></h3>
                                <div class="comLogo">
                                    <img src="/Public/Home/style/images/05ca024b95d242bb8178edaa5bd1b25a.jpg"
            ...
            <div class="content_r">
                ...
                <div class="greybg qrcode mt20">
                    <img src="/Public/Home/style/images/companylist_qr.png" width="242" height="242"
                         alt="拉勾微信公众号二维码"/>
                ...
                <a href="h/subject/jobguide.html" target="_blank" class="eventAd">
                    <img src="/Public/Home/style/images/subject280.jpg" width="280" height="135"/>
                </a>
                <a href="h/subject/risingPrice.html" target="_blank" class="eventAd">
                    <img src="/Public/Home/style/images/rising280.png" width="280" height="135"/>
                </a>
            </div>
        </div>
        ...
        <script type="text/javascript" src="/Public/Home/style/js/company_list.min.js"></script>
        <script>
            $(function () {
                /*分页 */
                $('.Pagination').pager({
